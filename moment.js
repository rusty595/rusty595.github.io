      ...
      for (var i = 0; i < lines.length; i++)
      {
        if (lines[i].length > 0)
        {
          ...
          else if (lines[i].includes("bsky.app"))
          {
            ...
            text += "<div style=\"margin: auto\"><blockquote class=\"bluesky-embed\" data-bluesky-uri=\"at://did:plc:wr33bahkchvqpn4lxpvagp6h/app.bsky.feed.post/" + lines[i].slice(lines[i].lastIndexOf("/")+1) + "\"><img height=32 style=\"image-rendering: pixelated; vertical-align: middle;\" src=\"/img/loading.gif\"><a href=\"" + lines[i] + "\">" + lines[i] + "</a></blockquote></div>";
          }
        }
      }
